...
% Document info
\textsc{\Large Artificial Intelligence Techniques}\\[0.2cm]
\textsc{\large IN4010-12}\\[1cm] 										% Course Code
\HRule \\[0.8cm]
{ \huge \bfseries Assignment 2: Problem Solving by Negotiation}\\[0.7cm]								% Assignment
\HRule \\[2cm]
\large
\emph{Authors:}\\[0.5cm]
...
Francesca Drummer (000000)\\[0.5cm]
{\large \today}\\[5cm]
